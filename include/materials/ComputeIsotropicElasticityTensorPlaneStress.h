...
/**
 * ComputeIsotropicElasticityTensorPlaneStress defines an elasticity tensor material for
 * isotropic materials.
 */
template <bool is_ad, typename T>
class ComputeIsotropicElasticityTensorPlaneStressTempl
  : public ComputeElasticityTensorBaseTempl<is_ad, T>
{
public:
...
typedef ComputeIsotropicElasticityTensorPlaneStressTempl<false, RankFourTensor>
    ComputeIsotropicElasticityTensorPlaneStress;
typedef ComputeIsotropicElasticityTensorPlaneStressTempl<true, RankFourTensor>
    ADComputeIsotropicElasticityTensorPlaneStress;
typedef ComputeIsotropicElasticityTensorPlaneStressTempl<false, SymmetricRankFourTensor>
    SymmetricIsotropicElasticityTensor;
typedef ComputeIsotropicElasticityTensorPlaneStressTempl<true, SymmetricRankFourTensor>
