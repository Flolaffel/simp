 ...
 */
class RadialAverageTop88 : public ElementUserObject
{
public:
  static InputParameters validParams();

  RadialAverageTop88(const InputParameters & parameters);
...
protected:
  ...
  friend class ThreadedRadialAverageLoopTop88;
};
...
template <>
class StandardType<RadialAverageTop88::QPData> : public DataType
{
public:
  explicit StandardType(const RadialAverageTop88::QPData * example = nullptr);
  StandardType(const StandardType<RadialAverageTop88::QPData> & t);
