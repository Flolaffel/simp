...
ThreadedRadialAverageLoopTop88::ThreadedRadialAverageLoopTop88(RadialAverageTop88 & green) : _radavg(green) {}

// Splitting Constructor
ThreadedRadialAverageLoopTop88::ThreadedRadialAverageLoopTop88(const ThreadedRadialAverageLoopTop88 & x,
                                                     Threads::split /*split*/)
  : _radavg(x._radavg)
{
}
...
void
ThreadedRadialAverageLoopTop88::operator()(const QPDataRange & qpdata_range)
{
  ...
  for (auto && local_qp : qpdata_range)
  {
    ...
    for (std::size_t j = 0; j < n_result; ++j)
    {
      ...
      switch (weights_type)
      {
        case RadialAverageTop88::WeightsType::CONSTANT:
          break;

        case RadialAverageTop88::WeightsType::LINEAR:
          weight = radius - std::sqrt(ret_matches[j].second);
          break;

        case RadialAverageTop88::WeightsType::COSINE:
