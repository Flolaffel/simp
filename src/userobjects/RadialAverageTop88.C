...
registerMooseObject("MooseApp", RadialAverageTop88);
...
InputParameters
RadialAverageTop88::validParams()
{
...
RadialAverageTop88::RadialAverageTop88(const InputParameters & parameters)
...
void
RadialAverageTop88::initialSetup()
{
...
void
RadialAverageTop88::initialize()
{
  _qp_data.clear();
}

void
RadialAverageTop88::execute()
{
...
void
RadialAverageTop88::threadJoin(const UserObject & y)
{
...
void
RadialAverageTop88::meshChanged()
{
...
void
RadialAverageTop88::updateCommunicationLists()
{
...
StandardType<RadialAverageTop88::QPData>::StandardType(const RadialAverageTop88::QPData * example)
{
  // We need an example for MPI_Address to use
  static const RadialAverageTop88::QPData p;
  if (!example)
    example = &p;
  ...
  libmesh_call_mpi(MPI_Get_address(const_cast<RadialAverageTop88::QPData *>(example), &start));
